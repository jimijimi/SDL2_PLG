/* 
   This is the second prototype of PW as shown in PLG.
   The main change is the addition of sound and music and threads.
...
static void PlayGame()
{
	...
	while (quit == 0) {
		...
		if ( opponent_type == OPP_COMPUTER ){
			if ( RunGameScript() !=0 ){
				printf( "Ending game due to script error.\n" );
				quit = 1;
			}
		}
...
int main(int argc, char *argv[])
{
	...
	if ( LoadGameScript( "pw.tcl" ) != 0 ){
		printf( "Exit due to script error.\n" );
		return 1;
	}
